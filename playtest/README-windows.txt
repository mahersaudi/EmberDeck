EmberDeck — نسخة تجريبية 0.1.0 (ويندوز)
========================================
...
1) كيف تفتح اللعبة
------------------
- فك الضغط عن الملف كامل (زر يمين ← «استخراج الكل»). لا تشغلها من داخل الملف المضغوط.
- داخل المجلد شغّل EmberDeck.exe
  (خلّ كل الملفات والمجلدات اللي جنبه في مكانها، اللعبة تحتاجها).
- تحتاج ويندوز 10 أو 11 (64-بت).
- أول مرة ممكن يطلع لك ويندوز رسالة «Windows protected your PC»، لأن النسخة غير موقّعة.
  الحل: اضغط «More info» (مزيد من المعلومات) ← «Run anyway» (تشغيل على أي حال).


2) قبل ما تبدأ
--------------
- اللعبة بالعربي والإنجليزي: من «Settings» ← «Language» غيّر اللغة، وتتطبق لما تطلع من الشاشة.
- تقدر تلعب بالماوس، أو الكيبورد (الأسهم + Enter + Esc)، أو يد تحكم (Xbox أو أي يد متوافقة).
...
-----------------------------
اضغط Win+R واكتب هذا وبعدها Enter:
   %USERPROFILE%\AppData\LocalLow\mahersaudi\EmberDeck
...
EmberDeck: Playtest build 0.1.0 (Windows)

Thanks for trying the game! Honest feedback is what matters most.

1) Opening it
   - Extract the whole zip first (right-click > Extract All). Don't run it from inside the zip.
   - Run EmberDeck.exe, and keep the files and folders next to it where they are.
   - Windows 10 or 11, 64-bit.
   - The build isn't signed, so Windows may show "Windows protected your PC":
...
5) If it freezes or crashes
   Press Win+R, enter %USERPROFILE%\AppData\LocalLow\mahersaudi\EmberDeck
